...
function registerError(name, code, description) {
    if(errors[code] == undefined)
        ...
        throw "Error code already registered!";
}
...
function init() {
    ...
    registerError('SCARD_E_PROTO_MISMATCH', 0x8010000F, 'The requested protocols are incompatible with the protocol currently in use with the smart card.');
